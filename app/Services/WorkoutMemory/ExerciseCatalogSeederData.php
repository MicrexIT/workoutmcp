...
class ExerciseCatalogSeederData
{
    ...
    private function strength(): array
    {
        return [
            ...
            $this->exercise('Pistol Squat', 'calisthenics', 'reps', ['bodyweight'], ['quads', 'glutes']),
            ...
            $this->exercise('Standing Calf Raise', 'strength', 'load_reps', ['machine', 'dumbbells'], ['calves'], [], 'canonical', true),
            $this->exercise('Seated Calf Raise', 'strength', 'load_reps', ['machine'], ['calves'], [], 'canonical', true),
