...
class LandingPageTest extends TestCase
{
    ...
    public function test_guest_sees_landing_with_connector_details(): void
    {
        ...
        $this->get('/')
            ...
            ->assertSee('href="https://chatgpt.com"', false)
            ->assertSee('href="https://claude.ai/customize/connectors"', false)
            ->assertSee('Claude Connectors')
            ->assertSee('Add custom connector')
            ->assertDontSee('Settings → Connectors')
